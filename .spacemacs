...
(custom-set-faces
 ...
 '(magit-diff-added ((t (:background "DarkOliveGreen4" :foreground "gray13"))))
 '(magit-diff-added-highlight ((t (:inherit magit-diff-added :background "#7B894f" :foreground "#B8BAB2"))))
 '(magit-diff-removed ((t (:background "firebrick4" :foreground "#BCBCBC"))))
