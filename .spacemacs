...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(ag kaolin-theme nix-mode auctex-latexmk)
...
`dotspacemacs/user-config' first."
  (setq-default dotspacemacs-themes '(spacemacs-dark kaolin))
  )
